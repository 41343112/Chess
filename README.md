...
## 🎉 新功能
- **Stockfish 引擎整合**：使用強大的 UCI 引擎進行電腦對戰！⭐ 最新功能
- **滑桿難度調整**：透過滑桿精確調整引擎技能等級（0-20）！⭐ 最新功能
- **開始對話框滾動**：支援滾動以適應更多設定選項！⭐ 最新功能
- **與電腦對戰**：選擇技能等級與 AI 對手對戰！⭐
- **語言選擇**：支援中文和英文介面切換！⭐
- **恢復預設值**：一鍵重置所有設定到預設值！⭐
...
1. **啟動遊戲 - 選擇模式**
   ...
   - 選擇遊戲模式：**玩家對戰** 或 **與電腦對戰** ⭐
   - 如選擇電腦對戰，可設定：
     - **技能等級**：使用滑桿選擇 0-20 的等級（0=最簡單，20=最困難）⭐ 新功能
     - 您的顏色：白方（先手）或黑方（後手）
   - 設定時間控制（可選）
   - 點擊「開始遊戲」
...
5. 保護好你的后，它是最強大的棋子
6. 嘗試創造攻擊對方國王的機會
7. **與電腦對戰時**：低技能等級適合練習，中等等級有挑戰性，高技能等級需要深思熟慮 ⭐

## 功能特色

### 遊戲模式
- ✅ **玩家對戰模式** - 兩位玩家輪流對戰 ⭐
- ✅ **電腦對戰模式** - 使用 Stockfish 引擎與 AI 對手對戰 ⭐ 最新功能
  - **引擎驅動**：使用強大的 Stockfish UCI 引擎
  - **技能等級 0-20**：透過滑桿調整難度
    - 0-5：簡單，適合初學者
    - 6-15：中等，有挑戰性
    - 16-20：困難，需要深思熟慮
...
- ✅ 8x8 棋盤，淺色和深色方格交替
- ✅ Unicode 國際象棋符號（♔ ♕ ♖ ♗ ♘ ♙）
- ✅ **滾動式開始對話框** - 支援較小螢幕顯示所有設定選項 ⭐ 最新功能
- ✅ **滑桿難度控制** - 精確調整 AI 引擎技能等級（0-20）⭐ 最新功能
- ✅ 視覺回饋：
  - 選中棋子高亮顯示（金色）
  - 有效移動高亮顯示（綠色）
  - **王被將軍高亮顯示（紅色）** ⭐
